...
<aside class="main-sidebar">
    ...
    <!-- /.search form -->
        ...
        <ul class="sidebar-menu">
            ...
            @endauth
            <li class="{{ active_class(Active::checkUriPattern('admin/subscriber')) }}">
            ...
            <li class="{{ active_class(Active::checkUriPattern('admin/subscriber/bulk-upload')) }}">
                <a href="{{ route('admin.subscriber.bulk-upload') }}">
                    <i class="fa fa-users"></i>
            ...
            <li class="{{ active_class(Active::checkUriPattern('admin/template')) }}">
