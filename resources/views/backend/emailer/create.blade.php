...
<form id="my_form" action="{!! route('frontend.upload-image') !!}" target="form_target" method="post" enctype="multipart/form-data" style="width:0px;height:0;overflow:hidden">
